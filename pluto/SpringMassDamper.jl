...
# ╔═╡ f9ef7fb2-bdbb-11ed-1424-95a754329472
using OrdinaryDiffEq

# ╔═╡ 002a3424-d71b-4c13-9f8f-e97e1dbd1cba
using Plots

# ╔═╡ 6c8fac87-b5dd-4729-b7c2-6c118a4ed6a8
md"# System parameters"

# ╔═╡ fd0f45ed-1cdb-4ef2-9f0a-b9e0c3aa6769
md"## Mass"

# ╔═╡ bdb8cba4-c49c-4dc6-97f7-42c4b53e303f
m = 310_000 # kg

# ╔═╡ 0e4630e5-bb34-48be-bdfc-b14eab1ccb93
md"## Damping coefficient"

# ╔═╡ dc9dd978-0c4a-4fa2-8e28-e7e50bd761f8
c = 20_000 # N.s/m (to be determined)

# ╔═╡ 295457a6-04f2-4382-8358-9afe4f562fa9
md"## Spring stiffness"

# ╔═╡ 49a7d090-2727-451e-b943-1337e232bc9d
k = 10_343_000 # N/m (hoist rope rope is 10_343_000)

# ╔═╡ 36fc4a2e-77f8-460a-a5d4-4242275527b2
md"## Undamped natural frequency"

# ╔═╡ 2e1c597d-77c1-4010-a45b-8bb4594ba7b9
ω = √(k / m) # rad/s

# ╔═╡ 425ebdcb-052d-40e3-b74d-0e3d26ec244a
f = ω / (2π) # Hz

# ╔═╡ 08d6b876-c040-4907-9727-0a1b970445e7
md"## Damping ratio"

# ╔═╡ 3f551b02-c447-4625-a5f5-ff57907728d5
ζ = c / (2 * m * ω)

# ╔═╡ 3ad28fd8-19ba-4bf6-97ca-3ba4ca0e105a
md"## Damped natural frequency"

# ╔═╡ 8b31e9bd-345b-4867-8d3e-c0285ee23c5d
ωd = ω√(1 - ζ^2) # rad/s

# ╔═╡ 12d21e50-cb85-4be9-a074-54994755b7e0
fd = ωd / (2π) # Hz
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "3ca10d39adf47b7da72886f923154e42c8a0400f"
