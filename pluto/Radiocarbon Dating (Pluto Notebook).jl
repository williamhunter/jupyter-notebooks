...
# ╔═╡ 87fd04f7-3d81-452b-a960-181e0c3795bb
using DifferentialEquations, Plots, PlutoUI; gr()

# ╔═╡ 9ce435be-45cc-11ed-2d3e-8d7a21638a0d
md"# Radiocarbon Dating"

# ╔═╡ 4f473df1-2993-4b00-89d0-53d02a199f38
md"Reference: [Wikipedia Article](https://en.wikipedia.org/wiki/Radiocarbon_dating)"

# ╔═╡ 810d916a-17c2-4f47-92f5-d80206e6d27f
md"## Add Packages"

# ╔═╡ 55e5e721-feb6-485e-beba-74729c73da76
md"## Describe Problem"

# ╔═╡ 6fa626e8-5b1c-47a9-860a-251e2787e39d
md"### Ordinary Differential Equation (ODE)"

# ╔═╡ d93c9cbb-ab7b-4b33-8452-dbc9bd2faa3f
md"$\frac{du}{dt} = pu$"

# ╔═╡ 56740847-ebc5-4017-b5be-20ef59f55e01
md"#### DifferentialEquations.jl"

# ╔═╡ 144ff1aa-4d60-4cc6-a9ba-79e1c8222e4f
md"##### Radiocarbon Dating Problem"

# ╔═╡ 67574cc7-afaa-4b26-b498-9a6fa3430154
md"$f(u, p, t) = pu$"

# ╔═╡ 669eb6c8-5c34-4f74-a8c2-a660de7b9897
md"## Define Function"

# ╔═╡ c0662e25-c366-457d-aa94-b3bf9f64ce28
f(u, p, t) = p * u

# ╔═╡ 2087fc12-86ed-4711-b5e4-c38436c4fa0b
md"## Assign Variables"

# ╔═╡ 171ce0d6-071c-43e7-ae98-159476bad757
md"### u: $^{14}C$ Percent Remaining"

# ╔═╡ 0bc7fe7e-dd66-47f6-81a2-d61c1666f2f7
u_begin = 1.0

# ╔═╡ 323a9091-db7f-427d-8adc-18d2d574b0be
md"### p: $^{14}C$ Decay Constant"

# ╔═╡ b7254d1b-2ce9-4e1e-a5b9-e7a79cd08f0a
const HALFLIFE = 5730.0 # ± 40 years

# ╔═╡ 2b6ae557-d5de-45f6-92c5-72a4e585520d
c = log(2) / HALFLIFE

# ╔═╡ 73d15096-496a-479b-8765-52ce7eb817b4
p = -c

# ╔═╡ 69452a64-9610-46e8-bf37-6d8b01978ec4
md"### t: Time in Years"

# ╔═╡ 15ed3e43-63ae-4b89-ab4d-27ea4fe187b2
t_begin = 0.0

# ╔═╡ c5d97352-bcb1-46b0-a7b9-6df264c01ba6
md"## Define ODE Problem"

# ╔═╡ 4f49ef69-35e3-43a1-803e-4c1449bb4395
md"## Solve Problem"

# ╔═╡ 590428f2-0461-4f1c-8896-dd36fd1c9b5a
md"## Plot Solution"

# ╔═╡ 3369dc63-d07d-4383-955b-c4b70bcc6fdd
md"Years: $(@bind t_end Slider(1.0:50_000.0, 50_000.0, true))"

# ╔═╡ e4205481-8815-42df-b36c-99370327bdf7
tspan = (t_begin, t_end)

# ╔═╡ 8c58cac0-2b91-4bd4-adee-8e66a46652d8
prob = ODEProblem(f, u_begin, tspan, p)

# ╔═╡ 69c2b1d0-25bd-4d3c-8345-40901bbcee18
sol = solve(prob)

# ╔═╡ 64f6458c-a68f-423a-b42b-eaa1ca2dd48f
sol(5730)

# ╔═╡ 2d1f0092-26be-4f24-9586-d7745c37ff3f
md" $^{14}C$ Percent Remaining: $(sol(t_end))"

# ╔═╡ 6696fa19-0fa7-4a0f-bed2-81b13fd01e47
plot(sol,
	legend = false,
	linewidth = 2,
...
# ╔═╡ cc100561-3ec5-43ad-8a59-b50b5df245bb
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "943c65707de240730b3509c1b1f390141fbb6faa"
